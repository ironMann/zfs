...
void space_reftree_add_flat_map(avl_tree_t *t, flat_range_tree_t *rt, int64_t refcnt);
// void space_reftree_generate_map(avl_tree_t *t, range_tree_t *rt,
    // int64_t minref);
void space_reftree_generate_flat_map(avl_tree_t *t, flat_range_tree_t *rt,
    int64_t minref);
