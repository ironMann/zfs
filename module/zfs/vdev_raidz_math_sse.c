...
const uint8_t sse_gf_mod_lt[2*256][16] __attribute__((aligned(256)));
...
{	\
	...
	case 4:	\
		__asm("prefetchnta %0" :: \
		"m" (((elem_t *)(ptr))[(offset)+2])); \
	case 2:	\
		__asm("prefetchnta %0" :: \
		"m" (((elem_t *)(ptr))[(offset)+0])); \
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 4:	\
		__asm("pxor %0, %%" VR3(r) : : "m" (((elem_t *)(src))[3]));\
		__asm("pxor %0, %%" VR2(r) : : "m" (((elem_t *)(src))[2]));\
	case 2:	\
		__asm("pxor %0, %%" VR1(r) : : "m" (((elem_t *)(src))[1]));\
	case 1:	\
		__asm("pxor %0, %%" VR0(r) : : "m" (((elem_t *)(src))[0]));\
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 8:\
		__asm("pxor %" VR0(r) ", %" VR4(r));\
		__asm("pxor %" VR1(r) ", %" VR5(r));\
		__asm("pxor %" VR2(r) ", %" VR6(r));\
		__asm("pxor %" VR3(r) ", %" VR7(r));\
		break;\
	case 4:\
		__asm("pxor %" VR0(r) ", %" VR2(r));\
		__asm("pxor %" VR1(r) ", %" VR3(r));\
		break;\
	case 2:\
		__asm("pxor %" VR0(r) ", %" VR1(r));\
		break;\
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 8:\
		__asm("movdqa %" VR0(r) ", %" VR4(r));\
		__asm("movdqa %" VR1(r) ", %" VR5(r));\
		__asm("movdqa %" VR2(r) ", %" VR6(r));\
		__asm("movdqa %" VR3(r) ", %" VR7(r));\
		break;\
	case 4:\
		__asm("movdqa %" VR0(r) ", %" VR2(r));\
		__asm("movdqa %" VR1(r) ", %" VR3(r));\
		break;\
	case 2:\
		__asm("movdqa %" VR0(r) ", %" VR1(r));\
		break;\
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 4:	\
		__asm("movdqa %0, %%" VR3(r) : : "m" (((elem_t *)(src))[3]));\
		__asm("movdqa %0, %%" VR2(r) : : "m" (((elem_t *)(src))[2]));\
	case 2:	\
		__asm("movdqa %0, %%" VR1(r) : : "m" (((elem_t *)(src))[1]));\
	case 1:	\
		__asm("movdqa %0, %%" VR0(r) : : "m" (((elem_t *)(src))[0]));\
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 4:	\
		__asm("pxor %" VR3(r)", %" VR3(r));\
		__asm("pxor %" VR2(r)", %" VR2(r));\
	case 2:	\
		__asm("pxor %" VR1(r)", %" VR1(r));\
	case 1:	\
		__asm("pxor %" VR0(r)", %" VR0(r));\
	}\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 4:	\
		__asm("movdqa %%" VR3(r)", %0" : "=m" (((elem_t *)(dst))[3]));\
		__asm("movdqa %%" VR2(r)", %0" : "=m" (((elem_t *)(dst))[2]));\
	case 2:	\
		__asm("movdqa %%" VR1(r)", %0" : "=m" (((elem_t *)(dst))[1]));\
	case 1:	\
		__asm("movdqa %%" VR0(r)", %0" : "=m" (((elem_t *)(dst))[0]));\
	}\
}
...
#define	MUL2_SETUP() \
{   \
	__asm("movd %0, %%xmm15" :: "r"(0x1d1d1d1d));	\
	__asm("pshufd $0x0, %xmm15, %xmm15");			\
}
...
{	\
	switch (REG_CNT(r)) {	\
	case 2:	\
	__asm("pxor    %xmm14,      %xmm14");   \
	__asm("pxor    %xmm13,      %xmm13");   \
	__asm("pcmpgtb %" VR0(r)",  %xmm14");   \
	__asm("pcmpgtb %" VR1(r)",  %xmm13");   \
	__asm("pand    %xmm15,      %xmm14");   \
	__asm("pand    %xmm15,      %xmm13");	\
	__asm("paddb   %" VR0(r)", %" VR0(r));	\
	__asm("paddb   %" VR1(r)", %" VR1(r));	\
	__asm("pxor    %xmm14,      %" VR0(r));	\
	__asm("pxor    %xmm13,      %" VR1(r));	\
	break;\
	}\
}
...
#define	MULx2(c, r...)	\
{	\
	__asm("movd %0, %%" _0f :: "r"(0x0f0f0f0f));\
	__asm("pshufd $0x0, %" _0f ", %" _0f);\
	/* upper bits */\
	__asm("movdqa %0, %%" _lt_mod_a			\
		: : "m" (sse_gf_mod_lt[2*(c)][0]));	\
	__asm("movdqa %0, %%" _lt_clmul_a			\
		: : "m" (sse_clmul_mod_lt[2*(c)][0]));	\
	\
	__asm("movdqa %" VR0(r) ", %" _a_save);\
	__asm("movdqa %" VR1(r) ", %" _b_save);\
	__asm("psraw $0x4, %" VR0(r));\
	__asm("psraw $0x4, %" VR1(r));\
	__asm("pand %" _0f ", %" _a_save);\
	__asm("pand %" _0f ", %" _b_save);\
	__asm("pand %" _0f ", %" VR0(r));\
	__asm("pand %" _0f ", %" VR1(r));\
	\
	__asm("movdqa %" _lt_mod_a ", %" _lt_mod_b);\
	__asm("movdqa %" _lt_clmul_a ", %" _lt_clmul_b);\
	\
	__asm("pshufb %" VR0(r) ",%" _lt_mod_a);\
	__asm("pshufb %" VR1(r) ",%" _lt_mod_b);\
	__asm("pshufb %" VR0(r) ",%" _lt_clmul_a);\
	__asm("pshufb %" VR1(r) ",%" _lt_clmul_b);\
	\
	__asm("pxor %" _lt_mod_a ",%" _lt_clmul_a);\
	__asm("pxor %" _lt_mod_b ",%" _lt_clmul_b);\
	__asm("movdqa %" _lt_clmul_a ",%" VR0(r));\
	__asm("movdqa %" _lt_clmul_b ",%" VR1(r));\
	\
	/* low bits */\
	__asm("movdqa %0, %%" _lt_mod_a				\
	...
	__asm("movdqa %" _lt_clmul_a ", %" _lt_clmul_b);\
	\
	__asm("pshufb %" _a_save ",%" _lt_mod_a);\
	__asm("pshufb %" _b_save ",%" _lt_mod_b);\
	__asm("pshufb %" _a_save ",%" _lt_clmul_a);\
	__asm("pshufb %" _b_save ",%" _lt_clmul_b);\
	\
	__asm("pxor %" _lt_mod_a ",%" VR0(r));\
	__asm("pxor %" _lt_mod_b ",%" VR1(r));\
	__asm("pxor %" _lt_clmul_a ",%" VR0(r));\
	__asm("pxor %" _lt_clmul_b ",%" VR1(r));\
}
...
RAIDZ_GEN_WRAP(p, sse);
RAIDZ_GEN_WRAP(pq, sse);
RAIDZ_GEN_WRAP(pqr, sse);

RAIDZ_REC_WRAP(p, sse);
RAIDZ_REC_WRAP(q, sse);
RAIDZ_REC_WRAP(r, sse);
RAIDZ_REC_WRAP(pq, sse);
RAIDZ_REC_WRAP(pr, sse);
RAIDZ_REC_WRAP(qr, sse);
RAIDZ_REC_WRAP(pqr, sse);

static boolean_t
raidz_math_will_sse_work(void)
{
	return (zfs_sse_available() &&
		zfs_sse2_available() &&
		zfs_ssse3_available());
}

const raidz_math_ops_t vdev_raidz_sse_impl = {
	.gen = { &sse_gen_p, &sse_gen_pq, &sse_gen_pqr },
	.rec = {
		&sse_rec_p, &sse_rec_q, &sse_rec_r,
		&sse_rec_pq, &sse_rec_pr, &sse_rec_qr,
		&sse_rec_pqr
	},
	.is_supported = &raidz_math_will_sse_work,
	.name = "sse"
};

#endif /* defined(RAIDZ_SSE_x86_64) */

#if defined(RAIDZ_SSE_x86_64) || defined(RAIDZ_AVX2_x86_64)

const uint8_t
__attribute__((aligned(256))) sse_gf_mod_lt[2*256][16] = {
...
const uint8_t
__attribute__((aligned(256))) sse_clmul_mod_lt[2*256][16] = {
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
#endif /* defined(RAIDZ_SSE) || defined(RAIDZ_AVX2) */
